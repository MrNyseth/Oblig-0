...
def test_add_float_excercise_2():
    tol = 1e-12
    assert np.abs(add(0.1, 0.2) - 0.3) < tol
...
def test_pow_eul_excercise_4():
    tol = 1e-12
    assert np.abs(pow_eul(7,1001) - np.exp(7)) < tol
